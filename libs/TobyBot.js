...
var mqttStart = require('./mqttStart.js');
var findHashtags = require('./hashtag.js').findHashtags;
var removeHashtags = require('./hashtag.js').removeHashtags;
 ...
 */
function TobyBot(botId, secret, onConnect, onMessage) {
...
module.exports = TobyBot;


//
// Message (sent and received as JSON string)
//    message: <String>, the raw message. Message is base64 string if not type "TEXT" or "JSON".
//    messageType <String>, either “TEXT”, “JSON”, “IMAGE”, “AUDIO”, or “VIDEO”.
//    tags: <List>, the labels the message is tagged with
//    ackTag: <String>, the acknowledgement tag.
//
